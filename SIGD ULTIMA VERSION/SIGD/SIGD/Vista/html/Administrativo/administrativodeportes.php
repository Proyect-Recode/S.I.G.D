...
<body>
  ...
  <div class="container-fluid contenido_deportes d-flex justify-content-center  ">
     ...
     <div class="opcion_deporte_futbol m-3 mb-4 ">
      ...
      <a href="../Administrativo/administrativofutbol.php" class="opcion_deporte_boton">Fútbol</a>
     ...
     <div class="opcion_deporte_basket m-3 mb-4">
      ...
      <a href="../Administrativo/administrativobasketball.php" class="opcion_deporte_boton">Basketball</a>
     ...
     <div class="opcion_deporte_handball m-3 mb-4">
      ...
      <a href="../Administrativo/administrativohandball.php" class="opcion_deporte_boton">Handball</a>
