...
<head>
    ...
    <title>S.I.G.D - Admin Mi cuenta</title>
...
<body>
  ...
  <nav class="navbar navbar-expand-lg  navbar-dark  " >
    ...
    <a class="navbar-brand d-flex justify-content-start m-3 " href="../Juez/juez.php">S.I.G.D</a>
    ...
    <div class="collapse navbar-collapse  " id="navbarNavDropdown">
      ...
      <li class="nav-item d-flex ">
        ...
        <a class="nav-link " href="../Juez/juez.php">Inicio </a>

      </li>
      <li class="nav-item">

        <a class="nav-link" href="../Juez/juezdeportes.php">Deportes</a>
      </li>
    ...
    <div class="menu">
        ...
        <li>
              <img class="icon-img" src="../../icons/user.png" alt=""> 
                <a href="../Juez/juezmicuenta.php">Mi cuenta</a>
          </li>
          
          
          <li>
                  <img class="icon-img" src="../../icons/equipo.png" alt="">
                  <a href="../Juez/juezvalidarincidencias.php">Cargar Incidencias</a>
          </li>
...
<form action="../../../Controlador/registro.php" method="post" class="">
...
<h1>Actualizacion de datos</h1>
  ...
  <div class="input_registro d-flex pt-3 justify-content-center">
   <input type="text" name="email" required placeholder="Ingrese Email">
  </div>
  
  <div class="input_registro d-flex pt-3 justify-content-center">
   <input type="password" name="npassword" required placeholder="Nueva Contraseña">
  </div>
  <div class="input_registro d-flex pt-3 justify-content-center">
   <input type="password" name="apassword" required placeholder="Contraseña Actual">
  </div>
