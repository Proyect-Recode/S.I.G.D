...
<head>
    ...
    <link rel="icons" href="../Vista/img/logo.png">
...
<body>
  ...
  <nav class="navbar navbar-expand-lg  navbar-dark  " >
    ...
    <img class="navbar-brand logo-navbar" src="../Vista/img/logo.png" alt="">

    <a class="navbar-brand d-flex justify-content-start m-3 " href="../Vista/Index.php">S.I.G.D</a>
...
<a class="nav-link" href="../Vista/deportes.php">Deportes</a>
</li>
  ...
  <div class="container-fluid contenido_deportes d-flex justify-content-center  ">
     ...
     <div class="opcion_deporte_futbol m-3 mb-4 ">
      ...
      <a href="../Vista/futbol.php" class="opcion_deporte_boton">Fútbol</a>
     ...
     <div class="opcion_deporte_basket m-3 mb-4">
      ...
      <a href="../Vista/basketball.php" class="opcion_deporte_boton">Basketball</a>
     ...
     <div class="opcion_deporte_handball m-3 mb-4">
      ...
      <a href="../Vista/basketball.php" class="opcion_deporte_boton">Handball</a>
