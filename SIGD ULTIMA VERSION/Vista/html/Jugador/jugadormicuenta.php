...
<body>
  ...
  <nav class="navbar navbar-expand-lg  navbar-dark  " >
    ...
    <a class="navbar-brand d-flex justify-content-start m-3 " href="../Jugador/jugador.php">S.I.G.D</a>
    ...
    <div class="collapse navbar-collapse  " id="navbarNavDropdown">
      ...
      <li class="nav-item d-flex ">
        ...
        <a class="nav-link " href="../Jugador/jugador.php">Inicio </a>

      </li>
      <li class="nav-item">

        <a class="nav-link" href="../Jugador/jugadordeportes.php">Deportes</a>
      </li>
    ...
    <div class="menu">
        ...
        <li>
              <img class="icon-img" src="../../icons/user.png" alt=""> 
                <a href="../Jugador/jugadormicuenta.php">Mi cuenta</a>
          </li>
