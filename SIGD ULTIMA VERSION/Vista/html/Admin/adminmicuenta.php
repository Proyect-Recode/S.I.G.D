...
<body>
  ...
  <nav class="navbar navbar-expand-lg  navbar-dark  " >
    ...
    <a class="navbar-brand d-flex justify-content-start m-3 " href="../Admin/admin.php">S.I.G.D</a>
      ...
      <ul class="navbar-nav ml-5 d-flex justify-content-end">
        ...
        <li class="nav-item d-flex ">
         ...
         <li class="nav-item">
          ...
          <a class="nav-link" href="../Admin/admindeportes.php">Deportes</a>
        </li>
    ...
    <div class="menu">
        ...
        <li>
              <img class="icon-img" src="../../icons/user.png" alt=""> 
                <a href="../Admin/adminmicuenta.php">Mi cuenta</a>
          </li>
          
          
          <li>
                  <img class="icon-img" src="../../icons/equipo.png" alt="">
                  <a href="../Admin/admincargarequipo.php">Cargar Equipo</a>
          </li>
