...
@include '../../Controlador/db.php.php';
        ...
        <div class="menu">
            ...
            <ul>
              ...
              <li>
                  ...
                  <a href="./html/configuracion.html">Configuración</a>
              </li>
              ...
              <li>
                ...
                <a href="./html/incidencias.html">Incidencias</a>
              </li>
  
              <li>
                   <img class="icon-img" src="./icons/incidencias.png" alt="">
                  <a href="./html/cargardatos.html">Cargar datos</a>
              </li>
